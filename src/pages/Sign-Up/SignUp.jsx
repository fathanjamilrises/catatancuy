...
function SignUp() {
    ...
    const handleSignUp = async (e) => {
        ...
        if(!name){
            setError('Masukan Nama Dengan Benar Yaa')
            return
        }
            ...
            <div className="bg-base-200 min-h-screen flex justify-center items-center">
                <div className="card md:card-side bg-base-100 shadow-xl max-w-4xl w-full">
                    ...
                    <div className="card-body md:w-1/2">
                        ...
                        <p className="text-sm text-gray-600 mb-5">Daftar Dulu Yuk Sebelum Lanjut</p>
                        ...
                        <div className="text-center">
                            <p>Udah Punya Akun?</p>
                            <Link to={'/login'} className="link link-hover link-primary">Langsung Login Aja Disini!</Link>
                        </div>
                    </div>
                </div>
            </div>
